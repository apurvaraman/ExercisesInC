...
// apurva@Silmaril:~/ExercisesInC/exercises/ex12$ time ./counter
//
// real	0m2.807s
// user	0m5.004s
// sys	0m0.040s
// apurva@Silmaril:~/ExercisesInC/exercises/ex12$ time ./counter_mutex
// 0 errors.
//
// real	0m16.936s
// user	0m13.120s
